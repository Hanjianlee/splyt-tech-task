...
export interface HFInterface {
 ...
 export function getDistanceHF({latitude1,latitude2,longitude1,longitude2}:HFInterface):number {
    var RaduisOfEarth:number = 6371; // Radius of the earth in km
    ...
    var distance:number = RaduisOfEarth * c; // Distance in km
    return distance;
  }
